 ...
 *
 * @param preserve indicates whether the permissions should be preserved.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 *
 * @param preserve indicates whether the group ownership should be preserved.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 * used.
 *
 * Windows compatability means accommodating some imprecision in the way certain filestytems on the Windows platform
 * record file modification timestamps.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
...
/**
 * @brief Set whether or not deletions in the source directory tree should be honoured.
 *
 * @param honour indicates whether deletions should be honoured.
 *
 * Honouring deletions means that files or directories in the source tree that have been removed since the last
 * synchronisation will also be removed from the destination tree.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
...
/**
 * @brief Set whether or not to use checksums to compare source and destination items.
 *
 * @param compare indicates whether checksums should be used.
 *
 * Using checksums means that the size and modification timestamp of files is not used as the sole indicator of whether
 * a file needs to be updated in the destination tree.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 *
 * Ignoring times generally means all files will be updated in the destination, regardless of whether the source is
 * actually different or not. (But see setAlwyasCompareChecksums()).
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 *
 * @param preserve indicates whether the device files should be preserved.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 *
 * @param partial indicates whether partially-transferred items should be kept.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 *
 * If this setting is set, symbolic links in the source tree will be copied as symbolic links; if not, symbolic links in
 * the source tree will be followed and the original file will be copied.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
...
/**
 * @brief Set whether or not backups of the destination tree should be made.
 *
 * @param backups indicates whether backups should be made.
 *
 * If this setting is set, backups of the pre-synchronisation entries in the destination tree will be made; if not,
 * destination entries will simply be overwritten.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 *
 * If compression is used, any data transferred to the destination will be compressed in transit. This is useful for
 * large data sets or when either the source or destination is remote.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 * updated.
 *
 * If this is set, any entries in the source tree that do not already exist in the destination tree will be ignored; if
 * this is not set, any entries in the source tree that do not already exist in the destination tree will result in new
 * entries being created in the destination tree.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
...
/**
 * @brief Set whether or not to ignore entries that already exist on the destination.
 *
 * @param noExisting indicates whether existing entries are ignored.
 *
 * If this is set, any entries in the source tree that already exist in the destination tree will be ignored; if this is
 * not set, any entries in the source tree that already exist in the destination tree will be updated in the destination
 * tree if the entry in the source tree is different.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
...
/**
 * @brief Set whether or not to use UID and GID to username and group name mapping.
 *
 * @param dontMap indicates whether to suppress UID and GID mapping.
 *
 * Ordinarily, UID and GID values will be mapped to usernames and group names so that the username and group name of
 * destination entries matches that of source entries. This can be suppressed so that the original UID and GID are used
 * on the destination entries. This makes little difference unless either the source or destination is remote and
 * therefore potentially uses different UIDs and GIDs for the same username and group name.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 *
 * If this setting is set, hard links in the source tree will be copied as hard links; if not, hard links in the source
 * tree will be followed and the original file will be copied.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
...
/**
 * @brief Set whether or not an itemised list of changes should be generated.
 *
 * @param show indicates whether an itemised list should be generated.
 *
 * @return @b true if the setting was set, @b false otherwise.
 */
 ...
 *
 * The log file can be set to a @b null or empty string to suppress capturing of the rsync command's standard output to
 * a log file.
 *
