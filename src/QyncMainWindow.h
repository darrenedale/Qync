...
#ifndef QYNCMAINWINDOW_H
#define QYNCMAINWINDOW_H
...
:	public QMainWindow {
	...
	private:
		...
		QyncPreset * m_tempPreset;
		QyncPreferencesDialogue * m_prefsWindow;
		 ...
		 */
		void fillPreset( QyncPreset * ) const;
	...
	protected:
		 ...
		 */
		bool setManager( QyncManager * manager );
	...
	public:
		 ...
		 * creator of the manager is responsible for its timely destruction.
		 */
		explicit QyncMainWindow( QyncManager * manager = 0 );

		/**
		 * \brief Destroy the QyncMainWindow.
		 */
		virtual ~QyncMainWindow( void );
		 ...
		 * \return The manager.
		 */
		QyncManager * manager( void ) const;
