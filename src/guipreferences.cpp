...
/**
 * @brief Initialise a new QyncGuiPreferences object.
 *
...
bool GuiPreferences::emitToolBarButtonStyleXml(QXmlStreamWriter & xml) const
{
    ...
    switch(toolBarButtonStyle()) {
        case Qt::ToolButtonIconOnly:
            xml.writeCharacters(QStringLiteral("IconOnly"));
            break;

        case Qt::ToolButtonTextOnly:
            xml.writeCharacters(QStringLiteral("TextOnly"));
            break;

        case Qt::ToolButtonTextBesideIcon:
            xml.writeCharacters(QStringLiteral("TextBesideIcon"));
            break;

        case Qt::ToolButtonTextUnderIcon:
            xml.writeCharacters(QStringLiteral("TextUnderIcon"));
            break;

        case Qt::ToolButtonFollowStyle:
            xml.writeCharacters(QStringLiteral("StyleDefault"));
            break;
    }
